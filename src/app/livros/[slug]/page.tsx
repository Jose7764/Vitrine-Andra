    ...
    <main className="px-5 py-14 lg:px-8">
      <section className="mx-auto grid max-w-7xl gap-10 rounded-[2rem] border border-gold/25 bg-ivory/62 p-5 shadow-soft md:grid-cols-[minmax(0,0.82fr)_minmax(0,1.18fr)] md:items-start md:p-9 lg:p-12">
        <div className="flex h-fit justify-center md:sticky md:top-28">
          <div className="relative w-full max-w-[340px] sm:max-w-[360px]">
            ...
            <Image
              ...
              height={510}
              priority
              className="relative aspect-[3/4.25] h-auto w-full rounded-2xl object-cover shadow-book"
            />
        ...
        <div className="flex min-w-0 flex-col">
          ...
          <h1 className="mt-4 break-words font-serif text-5xl leading-tight text-coffee sm:text-6xl">
            {book.title}
          </h1>
          <div className="ornament-divider my-6 font-serif text-lg">
            Apresentação do livro
          </div>
          <p className="max-w-3xl whitespace-pre-line break-words text-lg leading-9 text-walnut">
            {book.summary}
          </p>
